# Don't Remove Credit Tg - @shakib2016
...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7830631420:AAHLtX5ob_gAQqIcretJXPBKtBHOc-PeIJ0")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_TOKEN", "uploderxcmxbot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "23274996"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "7fa0c48ef9e57f8d92dba33ed6771e64")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "6552783238")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://himu1122:himu1122@cluster0.zfigslq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002775842088")) # your log channel id and make bot admin in log channel with full right 
